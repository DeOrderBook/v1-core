...
contract OptionFactory is OwnableUpgradeable, IOptionFactory {
     ...
     * @dev The new fee ratio must be in the range [0, 10000).
    ...
    function setOptionExerciseFeeRatio(uint256 optionId, uint16 _feeRatio) external onlyOwner {
        require(0 <= _feeRatio && _feeRatio < 10000, "OptionFactory: Illegal value range");
        address option = allOptions[optionId];
    ...
    function setOptionAllRatio(
        ...
        require(0 <= _entryFeeRatio && _entryFeeRatio < 10000, "Option: entryFeeRatio Illegal value range");
        require(0 <= _exerciseFeeRatio && _exerciseFeeRatio < 10000, "Option: exerciseFeeRatio Illegal value range");
        require(0 <= _withdrawFeeRatio && _withdrawFeeRatio < 10000, "Option: withdrawFeeRatio Illegal value range");
        require(0 <= _redeemFeeRatio && _redeemFeeRatio < 10000, "Option: redeemFeeRatio Illegal value range");
